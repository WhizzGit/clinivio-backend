...
import {
  Room, Bed, IPDAdmission, IPDVitalSnapshot,
  IPDTreatment, IPDProcedure, DischargeAdvice, DischargeSummary,
} from './ipd.entity';
...
export const ALL_ENTITIES = [
  ...
  DischargeAdvice, DischargeSummary, LabTest, LabOrder, LabOrderItem,
];
