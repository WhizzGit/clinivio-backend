...
export class AppointmentsController {
  ...
  findAll(
    ...
    return this.svc.findAll(tenantId, { doctorId, departmentId, patientId, status, from, to }, page, limit);
  }
  ...
  getActivePatients(
    ...
    return this.svc.getActivePatients(tenantId, { doctorId, departmentId, date });
  }
  ...
  confirmPayment(
    @Param('id') id: string,
    @TenantId() tenantId: string,
    @Body() body: { paymentMethod: string; amount: number; razorpayPaymentId?: string },
  ) {
